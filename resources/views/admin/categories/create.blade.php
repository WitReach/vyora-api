...
@section('content')
    <div class="w-full pb-24">
        ...
        <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6 px-1">
            <div>
                <h1 class="text-4xl font-black text-gray-900 tracking-tighter uppercase">New Category</h1>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                <label
                                    ...
                                    Name</label>
                                <input type="text" name="name" id="name" required placeholder="e.g. Streetwear"
                            ...
                            <div>
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="slug" id="slug" required placeholder="streetwear"
