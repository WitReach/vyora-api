...
<div class="w-full pb-24">
    <form action="{{ route('admin.size-charts.store') }}" method="POST" id="size-chart-form">
        @csrf

        {{-- Top Action Bar --}}
        <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6 px-1">
            <div>
                <h1 class="text-4xl font-black text-gray-900 tracking-tighter uppercase">Create Size Chart</h1>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                            ...
                            <table class="w-full text-left border-separate border-spacing-y-2" id="size-table">
                                <thead>
                                    <tr class="bg-gray-50/30">
                                        ...
                                        <th class="measurements-header px-6 py-4 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 text-center">Chest</th>
                                ...
                                <tbody id="size-rows" class="before:block before:h-2">
                                    <tr class="size-row group">
                                        ...
                                        <td class="px-6 py-4 bg-gray-50/30 border-y border-gray-50 group-hover:bg-gray-50 transition-colors">
                                            <input type="text" class="size-name block w-full bg-transparent border-0 p-0 text-xs font-bold text-gray-400 uppercase tracking-widest" placeholder="Size Name" readonly>
                                        </td>
            ...
            <div class="space-y-10">
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <input type="text" name="name" required
                                class="block w-full bg-gray-50/50 border-0 ring-1 ring-inset ring-gray-100 rounded-2xl py-4 px-5 text-sm font-bold text-gray-900 focus:ring-2 focus:ring-violet-500 transition-all" placeholder="e.g. Slim Fit Tee">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3"
                                ...
                                placeholder="Public notes for customers..."></textarea>
                        </div>
                ...
                {{-- Logic Alert Card --}}
                <div class="bg-violet-600 rounded-[2.5rem] p-10 text-white overflow-hidden relative group shadow-2xl">
                    <div class="absolute -right-10 -bottom-10 w-40 h-40 bg-white/20 blur-3xl group-hover:scale-125 transition-transform duration-700"></div>
                    <div class="relative z-10">
                        <div class="flex items-center gap-3 mb-6">
                            <div class="w-2 h-2 rounded-full bg-white animate-pulse"></div>
                            <h5 class="text-[10px] font-black uppercase tracking-[0.2em] text-violet-100">Size Chart Table</h5>
                        </div>
                    </div>
                </div>
            </div>
