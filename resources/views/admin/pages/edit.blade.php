...
@section('header', 'Edit Page Settings: ' . $mnpage->title)
...
<div class="w-full pb-24">
    ...
    <div class="mb-12 flex items-center justify-between">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-4xl font-black text-gray-900 tracking-tighter uppercase">Edit Page Settings</h1>
                <p class="text-[10px] font-bold text-gray-400 mt-1 uppercase tracking-[0.2em] italic">{{ $mnpage->title }}</p>
            </div>
        </div>
        <div class="flex items-center gap-4">
    ...
    <form action="{{ route('admin.online-store.mnpages.update', $mnpage) }}" method="POST" id="page-form" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="lg:col-span-2 space-y-10">
                ...
                <div class="bg-white rounded-[2.5rem] border border-gray-100 p-10 shadow-[0_8px_40px_rgba(0,0,0,0.03)]">
                    <div class="flex items-center gap-3 mb-10">
                        ...
                        <h3 class="text-xs font-black text-gray-900 uppercase tracking-widest">Page Information</h3>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-10">
                        ...
                        <div class="space-y-3">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $mnpage->title) }}" required
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center bg-white border border-gray-100 rounded-2xl overflow-hidden focus-within:ring-4 focus-within:ring-black/5 focus-within:border-black transition-all">
                                ...
                                <input type="text" name="slug" id="slug" value="{{ old('slug', $mnpage->slug) }}" required
                ...
                <div class="bg-white rounded-[2.5rem] border border-gray-100 p-10 shadow-[0_8px_40px_rgba(0,0,0,0.03)]">
                    ...
                    <div class="space-y-8">
                        <div class="space-y-3">
                            ...
                            <input type="text" name="meta_title" value="{{ old('meta_title', $mnpage->meta_title) }}"
                                class="w-full bg-white border border-gray-100 rounded-2xl px-6 py-4 text-sm font-bold text-gray-900 focus:ring-4 focus:ring-black/5 focus:border-black transition-all outline-none"
                        ...
                        <div class="space-y-3">
                            ...
                            <textarea name="meta_description" rows="4"
                                ...
                                placeholder="A brief summary of the page...">{{ old('meta_description', $mnpage->meta_description) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-[2.5rem] border border-gray-100 p-10 shadow-[0_8px_40px_rgba(0,0,0,0.03)]">
                    ...
                    <div class="space-y-6">
                        <label class="relative flex items-start gap-4 p-5 rounded-[2rem] border-2 border-gray-100/50 hover:border-emerald-500/20 cursor-pointer transition-all group has-[:checked]:border-emerald-500 has-[:checked]:bg-emerald-50/30">
                            <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $mnpage->is_active) ? 'checked' : '' }} class="hidden peer">
                        ...
                        <label class="relative flex items-start gap-4 p-5 rounded-[2rem] border-2 border-gray-100/50 hover:border-violet-500/20 cursor-pointer transition-all group has-[:checked]:border-violet-500 has-[:checked]:bg-violet-50/30">
                            <input type="checkbox" name="is_home" id="is_home" value="1" {{ old('is_home', $mnpage->is_home) ? 'checked' : '' }} class="hidden peer">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            <select name="layout" class="w-full bg-gray-50 border-none rounded-2xl px-6 py-5 text-[10px] font-black uppercase tracking-widest text-gray-900 focus:ring-4 focus:ring-black/5 transition-all appearance-none cursor-pointer">
                                <option value="default" {{ $mnpage->layout === 'default' ? 'selected' : '' }}>Global Default Setting</option>
                                <option value="contained" {{ $mnpage->layout === 'contained' ? 'selected' : '' }}>Contained Focus</option>
                                <option value="fluid" {{ $mnpage->layout === 'fluid' ? 'selected' : '' }}>Fluid (Edge-to-Edge)</option>
                            </select>
